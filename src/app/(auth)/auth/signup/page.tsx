    ...
    <div className="animate-fade-in">
      ...
      <div className="mt-6">
        ...
        <button
          ...
          disabled={loading}
          className="mt-4 w-full flex items-center justify-center gap-3 border-2 border-gray-300 py-2 px-4 rounded-lg font-semibold hover:bg-gray-50 transition-colors disabled:opacity-50"
        >
